...
<div class="flex items-center -m-2">
  <div class="w-auto p-10 text-right">
    <div
      class="flex items-center justify-center w-15 h-15 text-base font-medium rounded-md">
      ID</div>
  </div>
  <div class="w-auto p-2">
    <p class="text-xs font-semibold text-coolGray-800"></p>
    <p class="text-xs font-medium text-coolGray-500"></p>
  </div>
</div>
</th>
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-left">KEPADA</th>
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">ALAMAT</th>
<th class="whitespace-nowrap px-4 bg-white text-sm font-medium text-coolGray-800 text-center">UKM</th>
